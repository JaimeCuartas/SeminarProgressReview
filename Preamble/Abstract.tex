...
and
(3) the agents may use opaque black-box models
for each decision.

Despite the success of 
AI in sequential decision-making (e.g. Reinforcement Lerning),
...
to adress sequential actions with memory,
and (3) Formal Explainability for
stochastic models, where the outcomes
are uncertain by the environment.
