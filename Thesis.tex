...
\newcommand{\axp}{\mathsf{AXp}}
\newcommand{\cxp}{\mathsf{CXp}}
\newcommand{\YYY}{{\cal Y}}
\newcommand{\LLL}{{\cal L}}
\newcommand{\lwa}{\mathbb{W}}
...
\title  {Formal Explainability for Artificial Intelligence in Dynamic Environments}
...
%% ----------------------------------------------------------------
\setstretch{1.1}  % Set the line spacing to 1.5, this makes the following tables easier to read
...
\includepdf[pages=-,offset=2cm -2cm]{Chapters/XAI-DFA.pdf}
