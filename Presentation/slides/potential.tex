...
\begin{frame}{The CYK Algorithm: Bottom-Up Parsing}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.65\textwidth}
            ...
            \begin{tikzpicture}[
                ...
                % Row 4 (Top - Length 4)
                \node[cell, fill=green!20] (14) at (1.8, 2.4) {\{S\}};
    ...
    \vspace{0.4cm}
    \small{
    \textbf{Step 1:} Initialize the base row using terminal rules ($L \to \texttt{(}$, $R \to \texttt{)}$). \\
    \textbf{Step 2:} Build upward. E.g., cell \{X\} is formed because $X \to SR$, matching \{S\} and \{R\} below it. \\
    \textbf{Step 3:} The word is accepted because the Start variable $S$ appears in the top cell!
    }
\end{frame}
