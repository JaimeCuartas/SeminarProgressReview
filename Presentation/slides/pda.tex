...
\begin{frame}{Fragility of Acceptance vs. Robustness of Rejection}
    In Context-Free Languages. Consider balanced parentheses language $L=\{\texttt{()},\texttt{(())},\texttt{()()},\dots\}$:
...
\begin{frame}{Deducing Responsibility with PCFGs}
    \begin{itemize}
...
\begin{columns}[T]
    ...
    \begin{center}
        ...
        \textcolor{red}{\texttt{(}}\texttt{)}\textcolor{red}{\texttt{(}}\texttt{)} is a more common structure than \textcolor{red}{\texttt{((}}\texttt{))}.
        Thus, a better correction for \texttt{))))}.}
    \end{center}
\end{frame}
...
\begin{frame}{Project Plan \& Timeline}
    \textbf{Objective:} Timely completion of Phase 3 and thesis write-up.
    ...
    \vspace{0.4cm}
    \small{\textit{Feasibility Note:} The mathematical duality established in Phase 1 provides a robust foundation that drastically reduces the exploratory overhead for Phases 2 and 3.}
\end{frame}
...
\begin{frame}{Questions?}
    ...
    \begin{center}
        ...
        \normalsize{\textbf{Jaime}}\\
        
        \footnotesize{\texttt{jaime.cuartasgranada@monash.edu}}\\
    \end{center}
\end{frame}
