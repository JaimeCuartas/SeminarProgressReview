...
\begin{frame}{Explaining Finite Automata (Completed)}
    ...
    \let\thefootnote\relax\footnotetext{\tiny{
        Available on arXiv: ``A Formal Framework for the Explanation of Finite Automata Decisions''.
        %
...
\begin{frame}{Explaining Finite Automata (Completed)}
    ...
    \begin{tikzpicture}[
        ...
        \node[label] (lbl_cxp1) at (-2, -0.9) {CXp:};
        ...
        \node[wildcard, fill=red!10] (c1_1) at (0,-1.8) {a};
        \node[token, right=of c1_1] (c2_1) {b};
        \node[wildcard, fill=red!10, right=of c2_1] (c3_1) {a};
        \node[token, right=of c3_1] (c4_1) {b};
        \node[token, right=of c4_1] (c5_1) {b};
        \node[result, right=0.3cm of c5_1] {};
